...
class Practice_Feedback(al.HideOnForwardSection):
    ...
    def on_exp_access(self):
        ...
        self.Practice_Phase += al.Text("You will then see the estimate from the {} for the tip paid for each bill.".format(cond))
...
class Trials_Page2(al.Page):
    ...
    def on_first_show(self):
        ...
        self += al.Text("Your estimate: " + self.exp.values.get(f"prediction_{n+1:02}"))
...
class Part2(al.Page):
    ...
    def on_exp_access(self):
        ...
        self += al.Text("""
                        ...
                        You will then see the {}'s estimate for the tip paid for each bill. 
                        You will then have the chance to make a second estimate.
